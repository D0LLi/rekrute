...
<title>modifier mon espace recruteur</title>
</head>
<body>
  	<form:form action="/recruteur/updaterecruteur.html"   method="POST" commandName="recruteurModel">
		...
		<p>
			<form:label path="nom">Nom : </form:label> <form:input type="text"	id="form_lastpath" path="nom"  /> 
				<form:errors path="nom" cssClass="error" />
							 <form:input type="hidden"	id="form_lastpath" path="idRecruteur"  />  
